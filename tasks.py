    ...
    def plan_itinerary(self, agent, city, travel_dates, interests):
        return Task(
            ...
            **Description**: Expand the city guide into a full 7-day travel itinerary with detailed
                per-day plans, including weather forecasts, places to eat, packing suggetyions,
                and a budget breakdown. You MUST seggest actual places to visit, actual hotels to stay,
    ...
    def identify_city(self, agent, origin, cities, interests, travel_dates):
        return Task(
            ...
            **Description**: Analyse and select the best city for the trip based on specific 
                ...
                conditions, upcoming cultural or seasonal events, and overall travel expanses.
